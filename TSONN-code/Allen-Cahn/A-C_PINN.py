...
if __name__ == '__main__':
    ...
    # with open('dtau=1e0.pkl','wb') as file: file.write(pickle.dumps(nn)); file.close()
    
    #读取模型
    # with open('Possion2D_origin.pkl','rb') as file: pinn1 = pickle.loads(file.read())